    ...
    */
    public String nextToken()
    {
        ...
        if (Character.isDigit(input.charAt(start)))
        {
            ...
            //I modified this line below
            while (end < input.length() && (Character.isDigit(input.charAt(end)) || Character.compare(input.charAt(end), '.')==0 ))
            {
            end++;
            }
        }//Added this
        else if (Character.isAlphabetic(input.charAt(start)))
        {
            end = start + 1;
